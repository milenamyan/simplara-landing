      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {reasons.map((reason, index) => (
            <div 
              key={index}
              className="bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 border border-gray-200 hover:border-primary/50 hover:shadow-lg transition-all duration-300"
            >
              <div className="text-2xl sm:text-3xl md:text-4xl mb-2 sm:mb-3 text-center">{reason.icon}</div>
        ...
        <div className="mt-6 sm:mt-8 md:mt-10 text-center bg-gradient-to-r from-primary/10 to-purple-50 rounded-xl sm:rounded-2xl md:rounded-3xl p-5 sm:p-6 md:p-8 border-2 border-primary/20">
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-dark mb-2 px-2">
            {t("cta")}
          </p>
