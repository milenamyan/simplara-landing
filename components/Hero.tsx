...
export default function Hero() {
  ...
  return (
    <section className="relative bg-secondary overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8 sm:pb-10 lg:pt-24 lg:pb-12">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 items-center">
          ...
          <div className="relative mt-6 lg:mt-0">
            <div className="relative bg-gradient-to-br from-indigo-100 to-purple-100 rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-6 shadow-2xl max-w-md mx-auto">
              ...
              <div className="aspect-[9/16] w-full max-w-[280px] sm:max-w-sm mx-auto bg-white rounded-2xl sm:rounded-3xl shadow-xl overflow-hidden border-4 sm:border-8 border-gray-800">
                <div className="h-full bg-gradient-to-b from-gray-50 to-white p-2 sm:p-4 flex flex-col">
                  <div className="text-center mb-2 sm:mb-4">
                    <div className="inline-block bg-primary/10 rounded-full px-2 py-1 sm:px-4 sm:py-2 mb-1 sm:mb-2">
